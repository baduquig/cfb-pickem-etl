...
"""
import pandas as pd
from etl.scrape_schedule_page import get_all_game_ids
from etl.scrape_game_page import get_game_data
from etl.scrape_school_page import get_school_data
...
def full_extract():
    ...
    for school_id in games_df['home_school_id']:
