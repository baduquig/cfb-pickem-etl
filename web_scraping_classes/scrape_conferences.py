...
class ScrapeConferences:
    ...
    def scrape_conferences(self):
        ...
        for conf_div in conference_divs:
            ...
            conference_name = ScrapeAll.get_cell_text(conference_title_div)
            division_name = ''
            ...
            for conference_row in conference_table_rows:
                ...
                if 'subgroup-headers' in conference_row.get('class'):
                    ...
                    division_name = ScrapeAll.get_cell_text(division_span)
                    division_id += 1
                else:
                    school_span = conference_row.find('td').find('div').find_all('span')[2]
                    school_id = ScrapeAll.get_school_id(school_span)
                ...
                self.school_conferences_df = pd.concat([self.school_conferences_df, new_school_conference], ignore_index=True)
