...
class LoadData:
    ...
    def load_csv(self):
        ...
        if not self.games_df.empty:
            ...
            self.logfile.writelines(f'  ~ Loading games data into CSV file...\n')
            self.games_df.to_csv('./data/games.csv', index=False)

        if not self.schools_df.empty:
            print(f'  ~ Loading schools data into CSV file...')
            self.logfile.writelines(f'  ~ Loading schools data into CSV file...\n')
        ...
        if not self.conferences_df.empty:
            ...
            self.logfile.writelines(f'  ~ Loading conferences data into CSV file...\n')
        ...
        if not self.locations_df.empty:
            ...
            self.logfile.writelines(f'  ~ Loading locations data into CSV file...\n')
